...
class AsyncLoadOp(_ods_ir.OpView):
  ...
  def __init__(self, source, destination, barrier, indices, slice_lengths, collective, *, predicate=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_691')) else
      _ods_ir.AttrBuilder.get('anonymous_691')(collective, context=_ods_context))
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class LayoutCastOp(_ods_ir.OpView):
  ...
  def __init__(self, x, new_layout, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_697')) else
      _ods_ir.AttrBuilder.get('anonymous_697')(new_layout, context=_ods_context))
    _ods_successors = None
...
class TcGen05MMAOp(_ods_ir.OpView):
  ...
  def __init__(self, accumulator, a, b, accumulate, *, a_scaled=None, b_scaled=None, collective=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    operands.append(a_scaled)
    operands.append(b_scaled)
    _ods_context = _ods_get_default_loc_context(loc)
...
def tcgen05_mma(accumulator, a, b, accumulate, *, a_scaled=None, b_scaled=None, collective=None, loc=None, ip=None) -> _ods_ir.Value:
  return TcGen05MMAOp(accumulator=accumulator, a=a, b=b, accumulate=accumulate, a_scaled=a_scaled, b_scaled=b_scaled, collective=collective, loc=loc, ip=ip).result
