...
class WaitDMA2Op(_ods_ir.OpView):
  ...
  def __init__(self, semaphore, src, dst, *, device_id=None, core_id=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def wait_dma2(semaphore, src, dst, *, device_id=None, core_id=None, loc=None, ip=None) -> _ods_ir.Operation:
  return WaitDMA2Op(semaphore=semaphore, src=src, dst=dst, device_id=device_id, core_id=core_id, loc=loc, ip=ip)
